...
exports.addToCart = asyncHandler(async (req, res) => {
  // Check if user is logged in (Amazon-style)
  if (!req.session.userId) {
    // Store the intended action in session to redirect back after login
    req.session.returnTo = `/product/${req.body.productId}`;
    req.flash('error', 'Please sign in to add items to your cart');
