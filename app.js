...
app.get('/lang/:locale', (req, res) => {
  ...
  // Check for return parameter, otherwise use referer, otherwise default to shop
  const redirectUrl = req.query.return || req.get('Referer') || '/shop';
  console.log('Redirecting to:', redirectUrl);
  res.redirect(redirectUrl);
});

// POST route for language switching (for forms)
...
// Allow public access to shop and product pages (like Amazon)
app.get('/shop', cacheMiddleware(180), productController.viewProducts); // Cache for 3 minutes
app.get('/api/products/search', cacheMiddleware(60), productController.searchProducts); // Cache for 1 minute
app.get('/product/:id', cacheMiddleware(300), productController.viewProduct); // Cache for 5 minutes
...
app.post('/business-owner/purchase-bundle', isAuthenticated, isBusinessOwner, businessOwnerController.purchaseBundle);
app.get('/business-owner/products', isAuthenticated, isBusinessOwner, businessOwnerController.getProducts);
app.get('/business-owner/add-product', isAuthenticated, isBusinessOwner, businessOwnerController.getAddProduct);
app.post('/business-owner/products', isAuthenticated, isBusinessOwner, businessOwnerController.uploadProductImages, businessOwnerController.createProduct);
app.get('/business-owner/products/:id/edit', isAuthenticated, isBusinessOwner, businessOwnerController.getEditProduct);
app.post('/business-owner/products/:id', isAuthenticated, isBusinessOwner, businessOwnerController.uploadProductImages, businessOwnerController.updateProduct);
app.post('/business-owner/products/:id/delete', isAuthenticated, isBusinessOwner, businessOwnerController.deleteProduct);
app.get('/business-owner/income-analytics', isAuthenticated, isBusinessOwner, businessOwnerController.getIncomeAnalytics);
...
app.use((err, req, res, next) => {
  ...
  res.status(500).render('404', { 
    ...
    __: res.__ || ((key) => key),
    __n: res.__n || ((singular, plural, count) => count === 1 ? singular : plural),
    getLocale: res.locals.getLocale || (() => 'en'),
